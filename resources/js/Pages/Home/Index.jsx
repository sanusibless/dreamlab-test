        ...
        <HomeLayout>
            <div>
                <div id="template-mo-zay-hero-carousel" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <li data-bs-target="#template-mo-zay-hero-carousel" data-bs-slide-to={0} className />
                    <li data-bs-target="#template-mo-zay-hero-carousel" data-bs-slide-to={1} className="active" />
                    <li data-bs-target="#template-mo-zay-hero-carousel" data-bs-slide-to={2} className />
                    </ol>
                ...
                <section className="container py-5">
                    ...
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="http://localhost:8000/products"><img src="./assets/img/category_img_01.jpg" className="rounded-circle img-fluid border" /></a>
                        <h5 className="text-center mt-3 mb-3">Watches</h5>
                        <p className="text-center"><a href="http://localhost:8000/products" className="btn btn-success">Go Shop</a></p>
                    </div>
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="http://localhost:8000/products"><img src="./assets/img/category_img_02.jpg" className="rounded-circle img-fluid border" /></a>
                        <h2 className="h5 text-center mt-3 mb-3">Shoes</h2>
                        <p className="text-center"><a href="http://localhost:8000/products" className="btn btn-success">Go Shop</a></p>
                    </div>
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="http://localhost:8000/products"><img src="./assets/img/category_img_03.jpg" className="rounded-circle img-fluid border" /></a>
